...
# ================== 🤖 Mô hình dự báo ==================
st.header("🤖 Mô hình dự báo doanh số")
...
- **Chỉ số R² = {r2:.2f}**, cho thấy mô hình giải thích được khoảng **{r2:.2%}** phương sai trong dữ liệu.
- Các yếu tố ảnh hưởng lớn nhất gồm: `{', '.join(coef_df['Feature'].head(3))}`
- Mô hình phù hợp để **dự báo sơ bộ** và **hiểu nguyên nhân chính ảnh hưởng doanh số**.
""")
